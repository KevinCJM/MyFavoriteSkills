...
- Before normal user-facing work, run `skills/ai-hermes-user-project-memory/scripts/ai_hermes_user_project_memory.py --json recall` to dynamically resolve the current user/repo identity and load applicable project-scoped `repo_user` memories.
...
- Users can ask to remember, forget, enable, disable, view, audit, or apply personal project memory through `skills/ai-hermes-user-project-memory/scripts/ai_hermes_user_project_memory.py`; they may also explicitly request switch changes in prompts or edit the memory config file themselves.
