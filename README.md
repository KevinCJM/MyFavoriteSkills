...
| [`ui-design-research`](./ui-design-research/README.md) | 按需读取 23 个 UI 来源，结合项目约束做设计取舍与状态检查；附触发及行为评测用例，MCP 可选。 | Researches 23 UI sources on demand, guides project-aware design decisions and state checks, and includes trigger and behavior eval cases; MCP is optional. |
