...
- Skill 版本：`2.5.1`；本文更新于 2026-09-21。
...
- 怀疑卡住：定向查看正在执行的工具、测试进程或近期事件。安静的长测试可能正常；只有 `running` 标签也不足以证明有进展，需诊断具体操作。
...
Skill 离线工具与规则连接测试 **108 项通过**；另外准备的 **104 个行为场景尚未作为完整评测集执行**，二者不能混为一谈。v2.5 的 8 个效率场景及 v2.5.1 的 4 个等待/取消场景均待执行，本次未进行真实模型性能对照。可自行复验：
