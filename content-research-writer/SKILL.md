...
- Keep this skill self-contained; it does not require bundled scripts, API keys, or private files.
- Use the agent's available web search, web fetch, browser, or user-provided sources for research.
- If web access is unavailable, clearly mark research gaps and work only from provided materials.
- Prefer a user-specified working folder. If none is provided, use the current directory or a simple writing folder such as `./writing/<article-slug>/`.
- Do not assume the user has Claude Code, Codex, VS Code, Notion, or a specific editor; adapt to the current agent environment.
...
Open the current AI coding agent or editor from this directory and start writing.
...
1. **Work in a local editor or agent workspace**: Better for long-form drafts, source files, and iterative revisions
